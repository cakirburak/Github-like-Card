...
export class GridCardComponent {
  ...
  CardSyle: string = "flex flex-col items-center p-4 border border-1 border-gray-700 rounded-lg bg-[#161B22]";
  ...
  ButtonStyle: string = "flex gap-2 px-3 py-1 items-center " + 
                        "bg-[#21262C] hover:bg-[#30363C] border border-1 border-gray-700 hover:border-gray-400 rounded-lg " +
                        "transition-colors duration-300";
  // constant hover effects are prevented with transition and duration attributes
  // flex is used for aligning button elements horizontal(items-center)
